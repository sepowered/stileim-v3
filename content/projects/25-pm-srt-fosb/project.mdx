---
title: "SRT 승차 예매 편의성 개선 프로젝트 F/O 스토리보드"
description: "SRT 애플리케이션 승차권 예매 UI/UX 개선 프로젝트 F/O 스토리보드"
...
<div className="flex flex-col tablet:flex-row gap-3">
  <FileDownload fileKey="projects/25-pm-srt-fosb/SRT_모바일_APP_화면설계서.pdf" type="pdf">
    PDF로 스토리보드 보기
  </FileDownload>
  <a
